...
public:
    ...
    double getCTTaperDistance() const
    {
        return ctTaperDistance;
    }

    double getCTCutoffDistance() const
    {
        return ctCutoffDistance;
    }
    ...
    int addDispSite(double csixval)
    {
        csix.push_back(csixval);
    ...
    int getNumDispSites() const
    {
        return csix.size();
    }

    double getDispTaperDistance() const
    {
        return dispTaperDistance;
    }

    double getDispCutoffDistance() const
    {
        return dispCutoffDistance;
    }

    void setDispCutoffDistance(double taper, double distance)
    {
        dispTaperDistance = taper;
        dispCutoffDistance = distance;
    }


    void getDispParameters(int index, double& csixval) const
    {
        csixval = csix[index];
    }

    void setDispParameters(int index, double csixval)
    {
        csix[index] = csixval;
    }
    ...
    int addMultipole(double charge, const std::vector<double>& molecularDipole, const std::vector<double>& molecularQuadrupole, int axisType,
        ...
        multipoles.push_back(MultipoleInfo(charge, molecularDipole, molecularQuadrupole,  axisType, multipoleAtomZ,  multipoleAtomX, multipoleAtomY));
    ...
    void getMultipoleParameters(int index, double& charge, std::vector<double>& molecularDipole, std::vector<double>& molecularQuadrupole,
                                int& axisType, int& multipoleAtomZ, int& multipoleAtomX, int& multipoleAtomY) const {
    ...
    double getRepelTaperDistance() const
    {
        return repelTaperDistance;
    }

    double getRepelCutoffDistance() const
    {
        return repelCutoffDistance;
    }
    ...
    void getRepelParameters(int index, double& outputSize, double& outputDmp, double& outputElepr) const
    {
    ...
    void setRepelParameters(int index, double inputSize, double inputDmp, double inputElepr)
    {
...
protected:
    ...
    public:
        ...
        MultipoleInfo(double charge, const std::vector<double>& inputMolecularDipole,
    ...
    // dispersion
    double dispTaperDistance, dispCutoffDistance;
    std::vector<double> csix;
