...
#if USES_VIRIAL
vxx+= -1.0f*(ab.x*force1.x + cb.x*force3.x);
vxy+= -1.0f*(ab.y*force1.x + cb.y*force3.x);
vxz+= -1.0f*(ab.z*force1.x + cb.z*force3.x);
vyy+= -1.0f*(ab.y*force1.y + cb.y*force3.y);
vyz+= -1.0f*(ab.z*force1.y + cb.z*force3.y);
vzz+= -1.0f*(ab.z*force1.z + cb.z*force3.z);
#endif
